...
latex_documents = [
  (master_doc, 'bpak.tex', u'Bit-packer documentation',
...
man_pages = [
    (master_doc, 'bpak', u'Bit-packer documentation',
     [author], 1)
]
...
texinfo_documents = [
  (master_doc, 'Bpak', u'Bit-packer documentation',
   author, 'Bpak', 'One line description of project.',
   'Miscellaneous'),
]
